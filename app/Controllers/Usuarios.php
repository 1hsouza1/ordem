...
class Usuarios extends BaseController
{
    ...
    public function recuperaUsuarios()
    {
        ...
        $usuarios = $this->usuarioModel->select($atributos)
                                       ->asArray()//recuperando tods os usuários e excluidos
                                       ->withDeleted(true)
                                       ->orderBy('id', 'DESC')
                                       ->findAll();
    ...
    public function cadastrar()
    {
        ...
        // Gera um novo objeto da Entidade Usuário
        ...
        if ($this->usuarioModel->protect(false)->save($usuario)) {
            ...
            // Retorna o último ID inserido na tabela de usuarios
    ...
    public function atualizar()
    {
        ...
        // Preencheenchendo os atributos do usuário com os valores do POST
        $usuario->fill($post);
    ...
    public function upload()
    {
        ...
        // C:\xampp\htdocs\ordem\writable\uploads/usuarios/...  .jpg
        $caminhoImagem = WRITEPATH . "uploads/$caminhoImagem";

        
        // É possível manipular a imagem que está salva no diretório


        // Redimensiona a imagem para 300 x 300 e para ficar no centro
