        ...
        <div class="user-block block">
            ...
            <div class="btn-group">
                ...
                <div class="dropdown-menu">
                    ...
                    <a class="dropdown-item" href="<?php echo site_url("usuarios/editar/$usuario->id"); ?>">Editar
                        usuário</a>
                    <a class="dropdown-item" href="<?php echo site_url("usuarios/grupos/$usuario->id"); ?>">Gerenciar os
                        grupos de acesso</a>
                    ...
                    <a class="dropdown-item"
                        href="<?php echo site_url("usuarios/desfazerexclusao/$usuario->id"); ?>">Restaurar usuário</a>
